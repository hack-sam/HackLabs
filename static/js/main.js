...
const T = {
  es: {
    ...
    cert_verify_sub:       'Verifica códigos de certificado emitidos por HackLabs, incluso si aún no has completado el 100%.',
  ...
  en: {
    ...
    cert_verify_sub:       'Verify certificate codes issued by HackLabs, even if you have not yet completed 100%.',
