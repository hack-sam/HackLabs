...
const T = {
  es: {
    ...
    obj_title: 'Objetivo',
    obj_flag_lbl: 'Flag:',
    obj_flag_hint: '— valídala en la barra lateral.',
    ...
    upload_obj_flag_hint: '— valídala en la barra lateral.',
  ...
  en: {
    ...
    obj_title: 'Objective',
    obj_flag_lbl: 'Flag:',
    obj_flag_hint: '— validate it in the sidebar.',
    ...
    upload_obj_flag_lbl: 'Flag:',
    upload_obj_flag_hint: '— validate it in the sidebar.',
